...
try {
    $response = $client->get('https://api.github.com/repos/ZZROTDesign/docker-clean/git/refs/tags');
...
$folder = getcwd() . DIRECTORY_SEPARATOR . 'docker-clean';
if (!$fs->exists($folder)) {
    $fs->mkdir($folder);
}
